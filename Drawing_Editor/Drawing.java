...
public class Drawing extends JFrame{
    ...
    public class Menu extends JMenuBar implements ActionListener{
        ...
        {	
            ...
            this.vflipSm = new JMenuItem("Rotate Vertical");
            this.hflipSm = new JMenuItem("Rotate Horizontal");
            ...
            this.aboutSm = new JMenuItem("About Drawing Editor");		
     ...
     class ImageFilter extends FileFilter{  
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            else if(e.getSource() == this.openSm)
            {					
            ...
            else if(e.getSource() == this.saveSm)
            {
                if (imgNum != -1)
                {
                    JFileChooser fc =new JFileChooser(); 
            ...
            else if(e.getSource() == this.unduSm)
                paintWin[imgNum].pb.undo();
            
            else if(e.getSource() == this.redoSm)
                paintWin[imgNum].pb.redo();	

            else if(e.getSource() == this.clearSm)
            {
                if(imgNum != -1)
                    paintWin[imgNum].clearimage();
            }
            else if(e.getSource() == this.vflipSm)
            {
                if(imgNum != -1)
                    paintWin[imgNum].imageFlip(-1);	
            }
            else if(e.getSource() == this.hflipSm)	
            {
                if(imgNum != -1)
                    paintWin[imgNum].imageFlip(1);	
            }
            else if(e.getSource() == this.exitSm)
            {
                dispose();
                System.exit(0);
            }			
            else if(e.getSource() == this.aboutSm)
                JOptionPane.showMessageDialog(null, "Drawing Editor using JAVA GUI", "About Drawing Editor",JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    public class ToolBar extends JInternalFrame implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            {
                brushBut.setIcon(new ImageIcon("brush2s.jpg"));
                penBut.setIcon(new ImageIcon("pen1s.jpg"));
                fillBut.setIcon(new ImageIcon("fill1s.jpg"));
                lineBut.setIcon(new ImageIcon("line1s.jpg"));
                recBut.setIcon(new ImageIcon("kvad1s.jpg"));
                cirBut.setIcon(new ImageIcon("krog1s.jpg"));
                recFillBut.setIcon(new ImageIcon("kvadFill1s.jpg"));
                cirFillBut.setIcon(new ImageIcon("krogFill1s.jpg"));
                toolNum = 1;
            }
            else if (e.getSource() == this.penBut)
            {
                brushBut.setIcon(new ImageIcon("brush1s.jpg"));
                penBut.setIcon(new ImageIcon("pen2s.jpg"));
                fillBut.setIcon(new ImageIcon("fill1s.jpg"));
                lineBut.setIcon(new ImageIcon("line1s.jpg"));
                recBut.setIcon(new ImageIcon("kvad1s.jpg"));
                cirBut.setIcon(new ImageIcon("krog1s.jpg"));
            ...
            else if (e.getSource() == this.fillBut)
            {
                brushBut.setIcon(new ImageIcon("brush1s.jpg"));
                penBut.setIcon(new ImageIcon("pen1s.jpg"));
                fillBut.setIcon(new ImageIcon("fill2s.jpg"));
                lineBut.setIcon(new ImageIcon("line1s.jpg"));
                recBut.setIcon(new ImageIcon("kvad1s.jpg"));
                cirBut.setIcon(new ImageIcon("krog1s.jpg"));
                recFillBut.setIcon(new ImageIcon("kvadFill1s.jpg"));
            ...
            else if (e.getSource() == this.lineBut)
            {
                brushBut.setIcon(new ImageIcon("brush1s.jpg"));
                penBut.setIcon(new ImageIcon("pen1s.jpg"));
                fillBut.setIcon(new ImageIcon("fill1s.jpg"));
                lineBut.setIcon(new ImageIcon("line2s.jpg"));
                recBut.setIcon(new ImageIcon("kvad1s.jpg"));
                cirBut.setIcon(new ImageIcon("krog1s.jpg"));
                recFillBut.setIcon(new ImageIcon("kvadFill1s.jpg"));
                cirFillBut.setIcon(new ImageIcon("krogFill1s.jpg"));
            ...
            else if (e.getSource() == this.recBut)
            {
                brushBut.setIcon(new ImageIcon("brush1s.jpg"));
                penBut.setIcon(new ImageIcon("pen1s.jpg"));
                fillBut.setIcon(new ImageIcon("fill1s.jpg"));
                lineBut.setIcon(new ImageIcon("line1s.jpg"));
                recBut.setIcon(new ImageIcon("kvad2s.jpg"));
                cirBut.setIcon(new ImageIcon("krog1s.jpg"));
                recFillBut.setIcon(new ImageIcon("kvadFill1s.jpg"));
                cirFillBut.setIcon(new ImageIcon("krogFill1s.jpg"));
                toolNum = 5;
            }	
            else if (e.getSource() == this.recFillBut)
            {
                brushBut.setIcon(new ImageIcon("brush1s.jpg"));
                penBut.setIcon(new ImageIcon("pen1s.jpg"));
                fillBut.setIcon(new ImageIcon("fill1s.jpg"));
                ...
                recBut.setIcon(new ImageIcon("kvad1s.jpg"));
                cirBut.setIcon(new ImageIcon("krog1s.jpg"));
                recFillBut.setIcon(new ImageIcon("kvadFill2s.jpg"));
                cirFillBut.setIcon(new ImageIcon("krogFill1s.jpg"));
                toolNum = 6;
            }	

            else if (e.getSource() == this.cirBut)
            {
                brushBut.setIcon(new ImageIcon("brush1s.jpg"));
                penBut.setIcon(new ImageIcon("pen1s.jpg"));
                fillBut.setIcon(new ImageIcon("fill1s.jpg"));
                lineBut.setIcon(new ImageIcon("line1s.jpg"));
                recBut.setIcon(new ImageIcon("kvad1s.jpg"));
                cirBut.setIcon(new ImageIcon("krog2s.jpg"));
                recFillBut.setIcon(new ImageIcon("kvadFill1s.jpg"));
                cirFillBut.setIcon(new ImageIcon("krogFill1s.jpg"));
                toolNum = 7;
            }				
            else if (e.getSource() == this.cirFillBut)
            {
                brushBut.setIcon(new ImageIcon("brush1s.jpg"));
                penBut.setIcon(new ImageIcon("pen1s.jpg"));
                fillBut.setIcon(new ImageIcon("fill1s.jpg"));
                ...
                cirBut.setIcon(new ImageIcon("krog1s.jpg"));
                recFillBut.setIcon(new ImageIcon("kvadFill1s.jpg"));
                cirFillBut.setIcon(new ImageIcon("krogFill2s.jpg"));
                toolNum = 8;
            }	
        }	
    }
    ...
    class NewWindow extends JFrame implements ActionListener{
        ...
        NewWindow()
        {
            ...
            this.newW = new JTextField("400");
            this.newH = new JTextField("400");
        ...
        public void actionPerformed(ActionEvent e){		
            if(e.getSource() == this.newOK)
            {
                if (!newName.getText().equals(""))
                {
                    ...
                    JOptionPane.showMessageDialog(null, "Enter a valid image name", "Sorry invalid input", JOptionPane.ERROR_MESSAGE);
            }
            else
    ...
    class PaintBoard extends JPanel implements MouseListener,MouseMotionListener{
        ...
        public void drawRec(MouseEvent event,boolean filled){	    	
            ...
            if (filled){
                ...
                else if(mxs > event.getX() && mys < event.getY())
        ...
        public void fillColor(int ix, int iy){	    	
            //This method only works for very small areas;
        ...
        public void mouseDragged(MouseEvent event){  
            ...
            if (this.toolNum == 1)
                ...
                drawLine(event);
            else if (this.toolNum == 5)
                drawRec(event,false);			
            else if (this.toolNum == 6)
                drawRec(event,true); 		
            else if (this.toolNum == 7)
                drawCir(event,false);  
            else if (this.toolNum == 8)
                drawCir(event,true);  
        }
